const CACHE_NAME = 'sohibanir-dawat-v1';
const ASSETS = ['./','./index.html','./assets/css/styles.css','./assets/js/content.js','./assets/js/main.js','./assets/img/favicon.svg','./manifest.webmanifest'];
